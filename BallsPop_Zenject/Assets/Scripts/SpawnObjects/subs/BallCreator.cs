...
public class BallCreator
{
    ...
    public void PreparePool(int count, IBallEventsHandler ballEventsHandler)
    {
        ...
        for (int i = 0; i < ballsPool.Length; i++)
        {
            ...
            ball_sc.Init(ballEventsHandler);
